...
public class WeaverCategory implements IRecipeCategory<RecipeWrapper> {
	public static ResourceLocation Uid = new ResourceLocation(CutAndColored.MODID, "weavercategory");
	private static final int input1 = 0; // THE NUMBER = SLOTID
	private static final int output1 = 1; // THE NUMBER = SLOTID
	private final String title;
	private final IDrawable background;
	public WeaverCategory(IGuiHelper guiHelper) {
		this.title = "Weaver";
