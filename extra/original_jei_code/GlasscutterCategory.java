...
public class GlasscutterCategory implements IRecipeCategory<RecipeWrapper> {
	public static ResourceLocation Uid = new ResourceLocation(CutAndColored.MODID, "glasscuttercategory");
	private static final int input1 = 0; // THE NUMBER = SLOTID
	private static final int output1 = 1; // THE NUMBER = SLOTID
	private final String title;
	private final IDrawable background;
	public GlasscutterCategory(IGuiHelper guiHelper) {
		this.title = "Glasscutter";
