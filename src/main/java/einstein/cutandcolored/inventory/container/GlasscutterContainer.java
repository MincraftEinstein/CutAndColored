...
public class GlasscutterContainer extends Container
{
   ...
   public GlasscutterContainer(int windowIdIn, PlayerInventory playerInventoryIn) {
   ...
   public GlasscutterContainer(int windowIdIn, PlayerInventory playerInventoryIn, final IWorldPosCallable worldPosCallableIn) {
      ...
      this.outputInventorySlot = this.addSlot(new Slot(this.inventory, 1, 143, 33) {
         ...
         public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack) {
            ItemStack itemstack = GlasscutterContainer.this.inputInventorySlot.decrStackSize(1);
            ...
            worldPosCallableIn.consume((p_216954_1_, p_216954_2_) -> {
               ...
               if (GlasscutterContainer.this.lastOnTake != l) {
                  p_216954_1_.playSound((PlayerEntity)null, p_216954_2_, ModSounds.UI_GLASSCUTTER_TAKE_RESULT, SoundCategory.BLOCKS, 1.0F, 1.0F);
                  GlasscutterContainer.this.lastOnTake = l;
               }
   ...
   public boolean canInteractWith(PlayerEntity playerIn) {
      return isWithinUsableDistance(this.worldPosCallable, playerIn, ModBlocks.GLASSCUTTER);
   }
   ...
   private void updateRecipeResultSlot() {
      if (!this.recipes.isEmpty()) {
         GlasscuttingRecipe glasscuttingrecipe = this.recipes.get(this.selectedRecipe.get());
         this.outputInventorySlot.putStack(glasscuttingrecipe.getCraftingResult(this.inputInventory));
      } else {
         this.outputInventorySlot.putStack(ItemStack.EMPTY);
      }
