...
public class SmeltingRecipeGenerator extends RecipeResources {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		...
		smeltingRecipe(Blocks.STONE_BRICK_SLAB, ModBlocks.CRACKED_STONE_BRICK_SLAB, 0.1F, 200);
		smeltingRecipe(Blocks.STONE_BRICK_STAIRS, ModBlocks.CRACKED_STONE_BRICK_STAIRS, 0.1F, 200);
		smeltingRecipe(Blocks.STONE_BRICK_WALL, ModBlocks.CRACKED_STONE_BRICK_WALL, 0.1F, 200);
		
		smeltingRecipe(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS, ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICK_SLAB, 0.1F, 200);
		smeltingRecipe(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS, ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICK_STAIRS, 0.1F, 200);
		smeltingRecipe(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS, ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICK_WALL, 0.1F, 200);
