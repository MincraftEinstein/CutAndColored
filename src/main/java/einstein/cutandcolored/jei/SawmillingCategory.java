...
{
	public static final ResourceLocation UID = ModRecipeTypes.SAWMILLING.get().getRegistryName();
    ...
    public SawmillingCategory(final IGuiHelper guiHelper) {
        ...
        icon = guiHelper.createDrawableIngredient(new ItemStack(ModBlocks.SAWMILL.get()));
